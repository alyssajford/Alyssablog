...
<img src="{{site.url}}/{{site.baseurl}}/assets/images/post_2 - dessert1.png" alt="food.com" style="float: left; margin: 10px; width: 40%;/>
...
<img src="{{site.url}}/{{site.baseurl}}/assets/images/post_2 - libraries.png" alt="ImportingLibraries" style="float: left; margin: 10px; width: 40%; />
...
<img src="{{site.url}}/{{site.baseurl}}/assets/images/post_2 - url.png" alt="Website" style="float: left; margin: 10px; width: 40%;/>
